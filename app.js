    ...
    google: {
      ...
      levels: {
        ...
        group: {
          ...
          template: ["groupPattern"],
          fields: [
            {
              key: "groupPattern",
              label: "Назва групи (за типом кампанії)",
              type: "text",
              required: true,
              placeholder:
                "SRCH/PMAX: Brand_Puma, Buy_Sneakers, Mens_Sneakers; VID/DISP: INT | Real_Estate_Buyers; SHOP: Label | High_Margin",
              hint:
                "PDF: для SRCH/PMAX — напрямок/категорія; для VID/DISP — тип таргетингу | деталізація; для SHOP — критерій | значення.",
            },
          ],
        },
        asset: {
